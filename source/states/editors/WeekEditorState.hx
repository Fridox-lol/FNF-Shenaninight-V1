...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		missingFileText.setFormat(Paths.font("phantom.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	function addFreeplayUI() {
		...
		var fnfVerseCheckbox:FlxUICheckBox = new FlxUICheckBox(10, hideFreeplayCheckbox.y + 30, null, null, "Is in the FNF-Verse section?", 100);
		fnfVerseCheckbox.checked = weekFile.inFNFVerse;
		fnfVerseCheckbox.callback = function()
		{
			weekFile.inFNFVerse = fnfVerseCheckbox.checked;
		};
		...
		tab_group.add(fnfVerseCheckbox);
		tab_group.add(new FlxText(10, bgColorStepperR.y - 36, 0, 'YOU DONT NEED TO CHECK HIDE FREEPLAY TO HIDE IT FROM FNFVERSE WOOOOOOOOOOOOOO'));
		UI_box.addGroup(tab_group);
	}
